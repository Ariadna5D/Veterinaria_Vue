        ...
        <form @submit.prevent="validarYEnviar" class="flex flex-col gap-6" aria-labelledby="contact-title">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <FormGroup :label="t('contacto.formulario.campoCP')" :error="errores.cp" id="cp" :icon="MapPin">
                    <InputText id="cp" v-model="form.cp" :invalid="!!errores.cp" aria-required="true"
                        inputmode="numeric" :aria-invalid="!!errores.cp"
                ...
                <FormGroup :label="t('contacto.formulario.campoTelefono')" :error="errores.telefono" id="telefono"
                    :icon="Phone">
                    <InputText id="telefono" v-model="form.telefono" type="tel" inputmode="tel"
                        :invalid="!!errores.telefono" aria-required="true" :aria-invalid="!!errores.telefono"
            ...
            <FormGroup :label="t('contacto.formulario.campoConsulta')" :error="errores.mensaje" id="mensaje"
                ...
                <Textarea id="mensaje" v-model="form.mensaje" :invalid="!!errores.mensaje" rows="3" class="w-full"
                    aria-required="true" :aria-invalid="!!errores.mensaje"
            ...
            <div role="region" :aria-label="t('contacto.urgencias.titulo')"
